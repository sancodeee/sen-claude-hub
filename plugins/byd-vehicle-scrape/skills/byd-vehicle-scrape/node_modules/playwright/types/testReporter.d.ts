...
import type { TestStatus, Metadata, PlaywrightTestOptions, PlaywrightWorkerOptions, ReporterDescription, FullConfig, FullProject, Location } from 'playwright/types/test';
export type { FullConfig, FullProject, TestStatus, Location } from 'playwright/types/test';
